...
class CategoriesApi {
  ...
  Future<List<Category>> listCategories({int? groupId}) =>
      _guard(() async {
  ...
  Future<Category> createCategory(Map<String, dynamic> data) =>
      _guard(() => _dio.post('/categories', data: data)
